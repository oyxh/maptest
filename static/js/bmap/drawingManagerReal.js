/* eslint-disable no-use-before-define,eqeqeq,one-var,no-useless-escape,no-throw-literal,no-redeclare,no-unused-expressions,no-undef,no-sequences,no-mixed-spaces-and-tabs,no-tabs,no-new-func,new-cap,standard/object-curly-even-spacing,no-unused-vars */
/**
...
(function () {
  ...
  DrawingManager.prototype._bindPolylineOrPolygon = function () {
     ...
     */
    var startAction = function (e) {
      addPoint = (addPoint == null) ? e.point : addPoint
    ...
    var mousemoveAction = function (e) {
      ...
      var res
      var minPointLine = {x: e.point.lat,
        y: e.point.lng,
        dis: 0.0}
      ...
      addPoint = new window.BMap.Point(minPointLine.y, minPointLine.x)
      overlay.setPositionAt(drawPoint.length - 1, addPoint)
